...
const (
	...
	contentType = "application/vnd.schemaregistry.v1+json; charset=UTF-8"
...
func (client *SchemaRegistryClient) GetSchema(id int) (*goavro.Codec, error) {
	...
	fmt.Println("**************** I am GetSchema in SchemaREgistry ***********************")
	fmt.Println("I have Id with me")
	fmt.Println(id)
	fmt.Println("Got the Schema ")
